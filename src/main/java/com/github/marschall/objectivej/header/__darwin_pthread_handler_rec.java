...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ObjCRuntime.C_POINTER.withName("__routine"),
        ObjCRuntime.C_POINTER.withName("__arg"),
        ObjCRuntime.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = ObjCRuntime.upcallHandle(__routine.Function.class, "apply", $DESC);
