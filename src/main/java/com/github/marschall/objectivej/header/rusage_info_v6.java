...
public class rusage_info_v6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, ObjCRuntime.C_CHAR).withName("ri_uuid"),
        ObjCRuntime.C_LONG_LONG.withName("ri_user_time"),
        ObjCRuntime.C_LONG_LONG.withName("ri_system_time"),
        ObjCRuntime.C_LONG_LONG.withName("ri_pkg_idle_wkups"),
        ObjCRuntime.C_LONG_LONG.withName("ri_interrupt_wkups"),
        ObjCRuntime.C_LONG_LONG.withName("ri_pageins"),
        ObjCRuntime.C_LONG_LONG.withName("ri_wired_size"),
        ObjCRuntime.C_LONG_LONG.withName("ri_resident_size"),
        ObjCRuntime.C_LONG_LONG.withName("ri_phys_footprint"),
        ObjCRuntime.C_LONG_LONG.withName("ri_proc_start_abstime"),
        ObjCRuntime.C_LONG_LONG.withName("ri_proc_exit_abstime"),
        ObjCRuntime.C_LONG_LONG.withName("ri_child_user_time"),
        ObjCRuntime.C_LONG_LONG.withName("ri_child_system_time"),
        ObjCRuntime.C_LONG_LONG.withName("ri_child_pkg_idle_wkups"),
        ObjCRuntime.C_LONG_LONG.withName("ri_child_interrupt_wkups"),
        ObjCRuntime.C_LONG_LONG.withName("ri_child_pageins"),
        ObjCRuntime.C_LONG_LONG.withName("ri_child_elapsed_abstime"),
        ObjCRuntime.C_LONG_LONG.withName("ri_diskio_bytesread"),
        ObjCRuntime.C_LONG_LONG.withName("ri_diskio_byteswritten"),
        ObjCRuntime.C_LONG_LONG.withName("ri_cpu_time_qos_default"),
        ObjCRuntime.C_LONG_LONG.withName("ri_cpu_time_qos_maintenance"),
        ObjCRuntime.C_LONG_LONG.withName("ri_cpu_time_qos_background"),
        ObjCRuntime.C_LONG_LONG.withName("ri_cpu_time_qos_utility"),
        ObjCRuntime.C_LONG_LONG.withName("ri_cpu_time_qos_legacy"),
        ObjCRuntime.C_LONG_LONG.withName("ri_cpu_time_qos_user_initiated"),
        ObjCRuntime.C_LONG_LONG.withName("ri_cpu_time_qos_user_interactive"),
        ObjCRuntime.C_LONG_LONG.withName("ri_billed_system_time"),
        ObjCRuntime.C_LONG_LONG.withName("ri_serviced_system_time"),
        ObjCRuntime.C_LONG_LONG.withName("ri_logical_writes"),
        ObjCRuntime.C_LONG_LONG.withName("ri_lifetime_max_phys_footprint"),
        ObjCRuntime.C_LONG_LONG.withName("ri_instructions"),
        ObjCRuntime.C_LONG_LONG.withName("ri_cycles"),
        ObjCRuntime.C_LONG_LONG.withName("ri_billed_energy"),
        ObjCRuntime.C_LONG_LONG.withName("ri_serviced_energy"),
        ObjCRuntime.C_LONG_LONG.withName("ri_interval_max_phys_footprint"),
        ObjCRuntime.C_LONG_LONG.withName("ri_runnable_time"),
        ObjCRuntime.C_LONG_LONG.withName("ri_flags"),
        ObjCRuntime.C_LONG_LONG.withName("ri_user_ptime"),
        ObjCRuntime.C_LONG_LONG.withName("ri_system_ptime"),
        ObjCRuntime.C_LONG_LONG.withName("ri_pinstructions"),
        ObjCRuntime.C_LONG_LONG.withName("ri_pcycles"),
        ObjCRuntime.C_LONG_LONG.withName("ri_energy_nj"),
        ObjCRuntime.C_LONG_LONG.withName("ri_penergy_nj"),
        ObjCRuntime.C_LONG_LONG.withName("ri_secure_time_in_system"),
        ObjCRuntime.C_LONG_LONG.withName("ri_secure_ptime_in_system"),
        ObjCRuntime.C_LONG_LONG.withName("ri_neural_footprint"),
        ObjCRuntime.C_LONG_LONG.withName("ri_lifetime_max_neural_footprint"),
        ObjCRuntime.C_LONG_LONG.withName("ri_interval_max_neural_footprint"),
        MemoryLayout.sequenceLayout(9, ObjCRuntime.C_LONG_LONG).withName("ri_reserved")
