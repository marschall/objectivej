...
public class sigevent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ObjCRuntime.C_INT.withName("sigev_notify"),
        ObjCRuntime.C_INT.withName("sigev_signo"),
        sigval.layout().withName("sigev_value"),
        ObjCRuntime.C_POINTER.withName("sigev_notify_function"),
        ObjCRuntime.C_POINTER.withName("sigev_notify_attributes")
    ).withName("sigevent");
    ...
    public static class sigev_notify_function {
        ...
        private static final MethodHandle UP$MH = ObjCRuntime.upcallHandle(sigev_notify_function.Function.class, "apply", $DESC);
