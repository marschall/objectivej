...
public class policy_limits {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        policy_timeshare_limit.layout().withName("ts"),
        policy_rr_limit.layout().withName("rr"),
        policy_fifo_limit.layout().withName("fifo")
    ).withName("policy_limits");
    ...
    private static final long fifo$OFFSET = 8;
