...
public class policy_infos {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        policy_timeshare_info.layout().withName("ts"),
        policy_rr_info.layout().withName("rr"),
        policy_fifo_info.layout().withName("fifo")
    ).withName("policy_infos");
    ...
    private static final long rr$OFFSET = 20;
    ...
    private static final long fifo$OFFSET = 40;
