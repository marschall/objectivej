 ...
 * }
 */
public class mach_vm_read_entry {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ObjCRuntime.align(ObjCRuntime.C_LONG_LONG, 4).withName("address"),
        ObjCRuntime.align(ObjCRuntime.C_LONG_LONG, 4).withName("size")
    ).withName("mach_vm_read_entry");
