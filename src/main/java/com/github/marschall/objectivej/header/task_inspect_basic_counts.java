 ...
 * }
 */
public class task_inspect_basic_counts {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ObjCRuntime.C_LONG_LONG.withName("instructions"),
        ObjCRuntime.C_LONG_LONG.withName("cycles")
    ).withName("task_inspect_basic_counts");
    ...
    private static final long instructions$OFFSET = 0;
    ...
    private static final long cycles$OFFSET = 8;
