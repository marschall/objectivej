...
public class __darwin_arm_thread_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(29, ObjCRuntime.C_LONG_LONG).withName("__x"),
        ObjCRuntime.C_LONG_LONG.withName("__fp"),
        ObjCRuntime.C_LONG_LONG.withName("__lr"),
        ObjCRuntime.C_LONG_LONG.withName("__sp"),
        ObjCRuntime.C_LONG_LONG.withName("__pc"),
