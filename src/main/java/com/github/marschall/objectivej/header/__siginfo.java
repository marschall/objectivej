...
public class __siginfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ObjCRuntime.C_INT.withName("si_signo"),
        ObjCRuntime.C_INT.withName("si_errno"),
        ObjCRuntime.C_INT.withName("si_code"),
        ObjCRuntime.C_INT.withName("si_pid"),
        ObjCRuntime.C_INT.withName("si_uid"),
        ObjCRuntime.C_INT.withName("si_status"),
        ObjCRuntime.C_POINTER.withName("si_addr"),
        sigval.layout().withName("si_value"),
        ObjCRuntime.C_LONG.withName("si_band"),
        MemoryLayout.sequenceLayout(7, ObjCRuntime.C_LONG).withName("__pad")
    ).withName("__siginfo");
