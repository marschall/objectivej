 ...
 * }
 */
public class task_basic_info_32 {
    ...
    private static final OfInt virtual_size$LAYOUT = (OfInt)$LAYOUT.select(groupElement("virtual_size"));
     ...
     * }
     */
    public static final OfInt virtual_size$layout() {
     ...
     * }
     */
    public static int virtual_size(MemorySegment struct) {
     ...
     * }
     */
    public static void virtual_size(MemorySegment struct, int fieldValue) {
        struct.set(virtual_size$LAYOUT, virtual_size$OFFSET, fieldValue);
    }

    private static final OfInt resident_size$LAYOUT = (OfInt)$LAYOUT.select(groupElement("resident_size"));
     ...
     * }
     */
    public static final OfInt resident_size$layout() {
     ...
     * }
     */
    public static int resident_size(MemorySegment struct) {
     ...
     * }
     */
    public static void resident_size(MemorySegment struct, int fieldValue) {
    ...
    private static final long user_time$OFFSET = 12;
    ...
    private static final long system_time$OFFSET = 20;
    ...
    private static final long policy$OFFSET = 28;
