...
public class __darwin_ucontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ObjCRuntime.C_INT.withName("uc_onstack"),
        ObjCRuntime.C_INT.withName("uc_sigmask"),
        __darwin_sigaltstack.layout().withName("uc_stack"),
        ObjCRuntime.C_POINTER.withName("uc_link"),
        ObjCRuntime.C_LONG.withName("uc_mcsize"),
        ObjCRuntime.C_POINTER.withName("uc_mcontext")
