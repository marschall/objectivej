...
public class __sigaction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ObjCRuntime.C_POINTER.withName("sa_tramp"),
        ObjCRuntime.C_INT.withName("sa_mask"),
        ObjCRuntime.C_INT.withName("sa_flags")
    ...
    public static class sa_tramp {
        ...
        private static final MethodHandle UP$MH = ObjCRuntime.upcallHandle(sa_tramp.Function.class, "apply", $DESC);
